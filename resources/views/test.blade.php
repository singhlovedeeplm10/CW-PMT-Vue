        ...
        <div class="modal-content custom-modal">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3 d-flex justify-content-center align-items-center">
                    <div>
                        <input type="text" class="form-control" id="leaveStatusDisplay" readonly style="width: 100px;" />
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea id="reason" class="form-control" rows="3" readonly></textarea>
                </div>
...
<script>
document.getElementById('viewleavesmodal').addEventListener('show.bs.modal', function () {
    fetch('/leave-details')
...
<script>
    // Fetch leave data and populate the table when the page loads
    document.addEventListener('DOMContentLoaded', function () {
        fetch('/leave-details')
            .then(response => response.json())
            .then(leaves => {
                const leavesTableBody = document.querySelector('#leavesTable tbody');
                leavesTableBody.innerHTML = ''; // Clear existing rows
