    ...
    <div class="task-card">
      <div class="task-card-header">
        ...
        <div class="date-picker">
          ...
          <input type="date" id="date" v-model="selectedDate" class="form-control" @change="fetchDailyTasks" />
      ...
      <table class="task-table">
        ...
        <tbody>
          <tr v-for="(task, index) in tasks" :key="index">
            ...
            <td>{{ task.user.team_lead_name || "NA" }}</td>
            <td>
              <ul>
                <li v-for="(project, projectIndex) in task.projects" :key="projectIndex" :class="{
              ...
              <div v-for="(task, index) in currentTasks" :key="task.id" class="mb-4">
                <form @submit.prevent="updateTask(task)" class="d-flex align-items-center flex-wrap">
                  ...
                  <div class="form-group me-3 mb-3" style="flex: 1; min-width: 300px;">
                    ...
                    <select class="form-control" id="projectName" v-model="task.project_id">
                  ...
                  <!-- Hours Field -->
                  <div class="form-group me-3 mb-3" style="flex: 1; min-width: 150px;">
                    <label for="hours" class="form-label">Hours</label>
                    <input type="number" class="form-control" id="hours" v-model="task.hours" step="0.01" />
                  </div>
                  <!-- Task Description Field -->
                  <div class="form-group me-3 mb-3" style="flex: 2; min-width: 400px;">
                    <label for="taskDescription" class="form-label">Task Description</label>
                    <textarea class="form-control" id="taskDescription" v-model="task.task_description"></textarea>
                  </div>
                  <!-- Buttons -->
